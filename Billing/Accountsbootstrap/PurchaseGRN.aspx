                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-2">
                                     <div class="form-group">
                                            <label>
                                                Purchase Type:</label>
                                            <asp:DropDownList ID="drpPurchaseType"  AutoPostBack="true" OnSelectedIndexChanged="drpPurchaseType_OnSelectedIndexChanged" Enabled="true" runat="server" CssClass="chzn-select" Style="height: 30px" Width="100%">
                                                <asp:ListItem Text="From Purchase Order" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="Direct Purchase" Value="2"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    <div class="form-group">
                                        <label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlProcessOn" runat="server" CssClass="chzn-select" Style="height: 30px"
                                            Width="100%" Enabled="true" AutoPostBack="true" OnSelectedIndexChanged="ddlProcessOn_OnSelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group" id="BuyerCode" runat="server" visible="true">
                                            <label>
                                                BuyerCode :</label>                                           
                             ...
                             <div class="col-lg-12" id="dvDirectPur1" runat="server" visible="false">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>
                                                Items :</label>
                                    ...
                                    <div class="col-lg-1">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtQty" Height="30px" Width="100%" runat="server" AutoPostBack="true"
                                                AutoComplete="Off" OnTextChanged="txtQty_OnTextChanged1">
                                            </asp:TextBox>
                                    ...
                                    <div class="col-lg-1">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtRate" Height="30px" Width="100%" runat="server" AutoPostBack="true"
                                                AutoComplete="Off" OnTextChanged="txtRate_OnTextChanged1">
                                            </asp:TextBox>
                                ...
                                <div class="col-lg-12"  id="dvDirectPur2" runat="server" visible="false">
                                    <div class="col-lg-3">
