                ...
                <div class="panel panel-default">
                    ...
                    <div class="col-lg-12">
                            ...
                            <div id="div2" runat="server" style="overflow: auto; height: 250px; width: 100%">
                                <asp:GridView ID="GVItem" AutoGenerateColumns="False" GridLines="Both" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="DiscPer" HeaderStyle-Width="50px" Visible="false">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtDiscPer" Height="30px" Width="50px" runat="server" AutoPostBack="true" OnTextChanged="txtDiscPer_TextChanged" Text='<%#Eval("DiscPer")%>'></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <div class="col-lg-2">
                            ...
                            <asp:Label ID="DiscPer" runat="server" Visible="false"></asp:Label>
                            <asp:GridView ID="GVSizes" AutoGenerateColumns="False" GridLines="Both" runat="server"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo" HeaderStyle-Width="2%">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hdTaxID" runat="server" Value='<%#Eval("TaxID") %>' />
                                             <asp:HiddenField ID="hdDiscper" runat="server" Value='<%#Eval("Discper") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Rate">
                                     ...
                                     <asp:TemplateField HeaderText="DiscPer" HeaderStyle-Width="50px">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtDiscPer" Height="30px" Width="50px" runat="server" Text='<%#Eval("DiscPer")%>'></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
