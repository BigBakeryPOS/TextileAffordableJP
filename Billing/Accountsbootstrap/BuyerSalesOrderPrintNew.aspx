            ...
            <HeaderStyle CssClass="gradient" BorderStyle="Solid" />--%>
                        ...
                        <asp:BoundField DataField="Color" HeaderText="Color" Visible="false" FooterStyle-HorizontalAlign="Right"
                            FooterStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Left" />
                                        ...
                                        <asp:TemplateField HeaderText="Disc%" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldiscper" runat="server" Text='<%#Eval("discper") %>' Style="text-align: Center;"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="BeforeTAX" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="8%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBeforeTAX" runat="server" Text='<%#Eval("DisRate") %>' Style="text-align: Center;"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
