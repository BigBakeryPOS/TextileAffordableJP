<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SizeSettingNew.aspx.cs" Inherits="Billing.Accountsbootstrap.SizeSettingNew" %>
...
<body>
    ...
    <div class="col-lg-12" style="margin-top: 6px">
        <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 16px; font-weight: bold">Size Settings Master</h1>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="gv" runat="server"
                                            DataKeyNames="id" OnSelectedIndexChanged="gv_selectedindex" OnRowCommand="edit" EmptyDataText="Oops! No Activity Performed."
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="fit" DataField="fit" SortExpression="fit" HeaderStyle-ForeColor="Black" />
                                                <asp:BoundField HeaderText="Width" DataField="Width" SortExpression="Width" HeaderStyle-ForeColor="Black" />
                                                <asp:BoundField HeaderText="mtr" DataField="mtr" SortExpression="mtr" HeaderStyle-ForeColor="Black" />
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnedit" CommandArgument='<%#Eval("id") %>' CommandName="EditRow" runat="server">
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false" HeaderText="Delete">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="btndel" CommandArgument='<%#Eval("id") %>' CommandName="Del" runat="server">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-briefcase"></i>Add Size Settings
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    ...
                                    <div class="form-group">
                                        <label>Fit</label>
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="ddlFit" ValidationGroup="val1" Text="*" ErrorMessage="Please Select Fit!" Style="color: Red" />
                                        <asp:DropDownList ID="ddlFit" runat="server" class="form-control"></asp:DropDownList>

                                    </div>
                                    <div class="form-group">
                                        <label>Width</label>
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="ddlSize" ValidationGroup="val1" Text="*" ErrorMessage="Please Select Size!" Style="color: Red" />
                                        <asp:DropDownList ID="ddlSize" runat="server" class="form-control"></asp:DropDownList>

                                    </div>
                                    <label>Mtr</label>
                                    <asp:TextBox placeholder="Enter Mtr" ID="txtFit" runat="server" CssClass="form-control"></asp:TextBox>
...
ValidChars=" /,.\-#"  TargetControlID="txtaddress" />
 <asp:RequiredFieldValidator runat="server" ValidationGroup="val1" ID="RequiredFieldValidator111"
                        ...
                        <div role="alert">
                            <asp:Label ID="lblSuccess" runat="server" class="alert alert-success" Text="Well Done! You successfully Inserted." Visible="false"></asp:Label>
                            <asp:Label ID="lblFailure" runat="server" Text="Oops! Contact Already Exists." class="alert alert-danger" Visible="false"></asp:Label>
                            <asp:Label ID="lblWarning" runat="server" Text="Whoo!Did You Miss Something?" class="alert alert-warning" Visible="false"></asp:Label>
                        </div>
                    </div>
                    <!-- /.col-lg-4 -->
                </div>
