...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 id="head" runat="server" style="text-align: left; color: #fe0002; margin-top: -8px"></h2>
        </div>
    </div>
    <div class="row">
                            ...
                            <div class="form-group">
                                <div id="add" runat="server" class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="col-lg-3">
                                            <blink>
                                                <asp:Label runat="Server" id="lblblinktext" style="color: Green; font-size: 12px"></asp:Label>
                                            </blink>
                                            <div class="form-group">
                                                <label>
                                                    Party Type</label>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox CssClass="form-control" ID="txtDiscPer" runat="server"></asp:TextBox>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender312" runat="server"
                                                    TargetControlID="txtDiscPer" ValidChars="." FilterType="Numbers" />
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
